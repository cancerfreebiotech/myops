...
> **2026-07-07 更新**：**roadmap 可做項目已全部完成** —— #11 績效考核（v0.6.1）、GR 轉資產（v0.6.5）、B 類 7 項（v0.6.5）、Outlook 單向行事曆同步（v0.6.9：核准後自動推請假/出差到當事人 Outlook）皆已上線。剩下的只有「未來再評估」項（OCR 全文搜尋、彈性班別、打卡 GPS 圍欄，皆非承諾項）與 #13 服務台（Luna 決定不做）。
