      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            access: '查看：本人薪資　全員查看與核准：HR / 管理員（需授權）',
          },
          {
            icon: GraduationCap,
            href: '/training',
        ...
        modules: [
          {
            ...
            features: [
              ...
              'AI 翻譯：一鍵生成多語版本',
              '確認閱讀：追蹤重要文件的閱讀狀態',
              'OCR 全文搜尋：掃描 PDF / 圖片可一鍵抽取文字後供搜尋與 AI 引用（OCR 端點由管理員設定）',
            ],
        ...
        modules: [
          ...
          },
          {
            ...
            features: [
              ...
              'Can link an approved business trip; Finance can export details to Excel',
            ],
          ...
          },
          {
            ...
            access: 'View: own payroll　View all & approve: HR / Admin (with permission)',
          },
          {
            icon: GraduationCap,
            href: '/training',
        ...
        modules: [
          {
            ...
            features: [
              ...
              'OCR full-text search: extract text from scanned PDFs / images with one click for search and AI citation (OCR endpoint set by admin)',
            ],
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            access: '閲覧：本人のみ　全員閲覧・承認：HR / 管理者（権限が必要）',
          },
          {
            icon: GraduationCap,
            href: '/training',
        ...
        modules: [
          {
            ...
            features: [
              ...
              'AI翻訳：ワンクリックで多言語版を生成',
              '閲覧確認：重要文書の既読追跡',
              'OCR全文検索：スキャンPDF / 画像からワンクリックでテキスト抽出し、検索やAI引用に利用（OCRエンドポイントは管理者が設定）',
            ],
