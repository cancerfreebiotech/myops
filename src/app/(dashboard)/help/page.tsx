      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            title: '團隊總覽',
            desc: '依群組查看成員當日行程與完成回報；群組主管（Viewer）額外可見 KPI 並管理指標。',
            features: [
              '同群組一般成員也可互相查看彼此行程 / 完成回報（不含 KPI，刻意設計讓成員互相掌握進度）',
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            href: '/daily-report/team',
            title: 'Team Overview',
            desc: 'View group members\' daily schedule and completion notes by group; group leads (Viewers) also see KPIs and manage KPI metrics.',
            features: [
              'Regular members in the same group can also see each other\'s schedule / completion notes (KPIs excluded — by design, so members can track each other\'s progress)',
      ...
      },
      {
        ...
        modules: [
          ...
          },
          {
            ...
            href: '/daily-report/team',
            title: 'チーム概要',
            desc: 'グループ単位でメンバーの当日の行程・完了報告を確認できます。グループ責任者（Viewer）はさらにKPIを閲覧し、指標を管理できます。',
            features: [
              '同じグループの一般メンバー同士も互いの行程 / 完了報告を閲覧可能（KPIは含みません。メンバー間で進捗を把握し合えるよう意図的に設計）',
